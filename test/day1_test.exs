defmodule Day1Test do
  ...
  test "solves day one part one" do
    ...
    assert Day1.calculate_distance_of_lists(first_list, second_list) == 1_197_984
  end
  ...
  test "solves day one part two" do
    ...
    assert Day1.calculate_similarity_score_of_lists3(first_list, second_list) == 23_387_399
  end
end
